        ...
        >
          ...
          <div className="prose prose-indigo max-w-none space-y-6 text-gray-700">
            <section>
              ...
              <p>
                <strong>Karbon Kurs Plus</strong> olarak, 6698 sayılı Kişisel Verilerin Korunması Kanunu (&quot;KVKK&quot;) uyarınca, 
            ...
            <section>
              ...
              <p>
                ...
                <strong> info@karbonkursplus.com</strong> adresine başvurabilirsiniz.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-gray-50 p-4 rounded-lg mt-4">
                <p><strong>Veri Sorumlusu:</strong> Karbon Kurs Plus</p>
                <p><strong>E-posta:</strong> info@karbonkursplus.com</p>
              </div>
            </section>
